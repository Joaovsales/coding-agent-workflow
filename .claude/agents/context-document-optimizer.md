...
description: Optimize XML or Markdown documentation for AI coding agents by producing token-efficient summaries that preserve every critical technical detail. Use PROACTIVELY when a document is too verbose for efficient agent context.
model: sonnet
color: pink
---
